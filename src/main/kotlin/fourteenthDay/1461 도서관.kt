...
fun main(){
    ...
    val wholeList = LinkedList<Int>()
    for (index in list.indices){
        wholeList.add(list[index])
        if (list[index] > 0)
            plus.add(list[index])
        else
...
//    if (value == 0){
//        var sum = 0
//        var first = wholeList.first()
//        var i = 0
//        while (wholeList.isNotEmpty()){
//            i++
//            if (i == 1){
//                sum += Math.abs(first)
...
//            }
//            else{ // 5
//                sum += Math.abs(first - wholeList.first())
//                first = wholeList.removeFirst()
//            }
//            if (i == m){
//                sum += Math.abs(first)
//                if (wholeList.isNotEmpty())
//                    first = wholeList.first()
//                i = 0
//            }
//        }
//        println(sum - first)
